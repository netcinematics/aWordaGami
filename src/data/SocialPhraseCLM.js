export default function SocialPhraseCLM(){ //CUSTOM-LANGUAGE-MODEL
    return ['rise to the occasion','bottom of the ocean','act of desperation','warm congratulations','just a simulation','fill in the blank','raise all boats', 'good to go', 'early bird gets the worm', 'get it while its hot',
        ...
        'blown out of porportion','up to no good','get the notion',
    ]}