export default function SocialPhraseCLM(){ //CUSTOM-LANGUAGE-MODEL
    return ['fill in the blank','raise all boats', 'good to go', 'early bird gets the worm', 'get it while its hot',
        ...
        'it was a grey gloomy day','it was a dark and stormy night','you get the idea','get the notion','instant gratification',
        ...
        'blown out of porportion','act of desperation','warm congratulations','just a simulation'
    ]}